...
# UI
# ============================================================
st.title("🎯 UniHack: Product Intelligence Enrichment")
st.markdown(
...
if not API_KEY:
    st.error("🚨 GROQ_API_KEY not set. Add it to Streamlit Secrets or a local .env file.")
    st.stop()

with st.sidebar:
    st.header("⚙️ Reference Files (optional)")
